...
public class QRActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adresIP = (TextView)findViewById(R.id.textView);
        adres = "dupa";

        barecodeD = new BarcodeDetector.Builder(this)
                .setBarcodeFormats(Barcode.QR_CODE).build();

        cameraSource = new CameraSource.Builder(this, barecodeD)
        ...
        barecodeD.setProcessor(new Detector.Processor<Barcode>() {
            @Override
            public void release() {
